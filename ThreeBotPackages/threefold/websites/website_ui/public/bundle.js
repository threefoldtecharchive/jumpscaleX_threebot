...
var app = (function () {
    ...
    const file$2 = "src/components/Community.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 12, 0, 228);
    		},
    ...
    class Community extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Community", options, id: create_fragment$5.name });
    	}
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			router.$$.fragment.c();
    			add_location(div0, file$3, 6, 0, 140);
    			attr_dev(div1, "class", "container-fluid");
    			add_location(div1, file$3, 11, 0, 183);
    		},
