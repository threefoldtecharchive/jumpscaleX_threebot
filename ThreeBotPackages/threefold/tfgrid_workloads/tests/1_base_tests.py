...
def main(self):
    ...
    threebots = [{"role": "signer", "pubkey": binascii.hexlify(signer_signing_key.verify_key.encode())}, {"role": "farmer", "pubkey": binascii.hexlify(farmer_signing_key.verify_key.encode())}, {"role": "customer", "pubkey": binascii.hexlify(customer_signing_key.verify_key.encode())}]
    tbots = {}
