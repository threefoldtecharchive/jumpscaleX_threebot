...
export default class DeployedDomainView extends JetView {
    config() {

        let data = [
            {
                id: "1", type: "folder", value: "domain1", data: [
                    { id: "p_0_1", type: "file", value: "ID" },
                    { id: "p_0_0", type: "file", value: "name" }
                ]
            },
            {
                id: "2", type: "folder", value: "domain2", data: [
                    { id: "p_1_1", type: "file", value: "ID" },
                    { id: "p_1_0", type: "file", value: "name" }
                ]
            },
            {
                id: "3", type: "folder", value: "domain3", data: [
