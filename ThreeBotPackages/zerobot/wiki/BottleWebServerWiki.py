...
@app.route("/wiki/<docsite>/<url>/<pagename>.md", method="get")
@enable_cors
def wiki_handler_md(docsite):
    # TODO: fetch your markdown doc from the BCDB
    # TODO: check if dynamic macro inside, so we can render the markdown dynamically
    pass
