...
def chat(bot):
    ...
    reservation = j.sal.zosv2.new_reservation(user, expiration_provisioning, expiration_reservation)
    ...
    cont = j.sal.zosv2.create_container(network.name,ip_address,node.node_id, reservation, conatiner_flist, storage_url,env, entry_point)
