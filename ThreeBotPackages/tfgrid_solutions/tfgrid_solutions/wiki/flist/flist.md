...
The deployed container will be started using an flist provided through the chatflow.
...
OR
- Through the url: `{host}/tfgrid_solutions/tfgrid_solutions/chat/your_flist`
...
- register user threebot on explorer `kosmos "j.tools.threebot.init_my_threebot(name=3bot_NAME,email=EMAIL)"`
