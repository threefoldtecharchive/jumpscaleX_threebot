module.exports = new Promise(async (resolve, reject) => {
  ...
  resolve({
    name: "capacitymap",
    components: { 
      capacityselector: 'url:/threebot/capacity_standalone/components/capacityselector/index.vue',
      nodeinfo: 'url:/threebot/capacity_standalone/components/nodeinfo/index.vue'
    },
    props: [],
    data() {
      return {
